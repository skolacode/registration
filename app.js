...
// 1. Your Firebase Configuration Object (values injected via env.js -> window.ENV)
...
if (!firebaseConfig.apiKey) {
  console.error("Firebase config missing. Ensure env.js is present (local) or generated by the deploy workflow.");
}
